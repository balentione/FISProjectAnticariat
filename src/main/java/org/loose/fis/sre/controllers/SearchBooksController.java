...
public class SearchBooksController {
    ...
    private void handleBuySelected() throws IOException{
        for(PublishedBooks publishedBooks : books_table.getSelectionModel().getSelectedItems()){
            UserService.makeOffer(publishedBooks.getUsername(),User.getLast_username(),publishedBooks.getCategory(),publishedBooks.getTitle(),publishedBooks.getAuthor(),publishedBooks.getNumber_pag(),publishedBooks.getCondition());
