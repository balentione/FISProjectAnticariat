...
public class LoggedInCustomerController {
    ...
    private void handleViewBooks() throws IOException {
        Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("searchBooks.fxml")); //de modificat
    ...
    private void handleViewBuyedBooks() throws IOException {
        Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("buyedBooks.fxml")); //de modificat
