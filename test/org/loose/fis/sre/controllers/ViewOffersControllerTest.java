...
class ViewOffersControllerTest {
    @BeforeEach
    void setUp() throws Exception {
        FileSystemService.APPLICATION_FOLDER = ".test-viewoffers";
    ...
    @Test
    @DisplayName("Functionalitatea butonului de Accept")
    void testAcceptButton(FxRobot robot) {
        robot.clickOn("#back_button");
    }

    @Test
    @DisplayName("Functionalitatea butonului de Reject")
